...
const BannerBottom = () => {
    return (
      <div className=" absolute  -mt-24 left-0 right-0 max-w-7xl mx-auto flex flex-col gap-10 lg:gap-0 lg:flex-row justify-center items-center h-auto lg:h-60 bg-slate-600 text-white py-10 px-8 z-50">
        ...
        <div className="w-full lg:w-[40%] flex items-center justify-center gap-2 lg:gap-8">
          <div className="w-full flex flex-col items-center group">
            ...
            <p className="text-xs md:text-sm text-white/50 group-hover:text-white">
              watch on youtube
            </p>
          </div>
